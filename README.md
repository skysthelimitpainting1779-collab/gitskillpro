...
`SPEC.md` is the canonical implementation contract. Older design notes under `docs/superpowers/specs/` are supporting design history and are superseded where they conflict with `SPEC.md`.
